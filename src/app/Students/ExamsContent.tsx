    ...
    return (
        ...
        >
            <div className="flex items-center mb-6">
                <GraduationCap className="w-8 h-8 text-[#e30f28] mr-3" />
                <h2 className="text-2xl font-bold text-slate-800">Mis Resultados de Exámenes</h2>
            </div>

            {examResults.length === 0 ? (
                <div className="text-center py-12">
                    <Award className="w-16 h-16 text-gray-400 mx-auto mb-4" />
                    <p className="text-gray-500 text-lg">No tienes exámenes registrados</p>
                </div>
            ) : (
                                ...
                                <div className="text-right">
                                    <div className="flex items-center mb-2">
                                        ...
                                        <span className={`font-bold ${
                                            result.aprobado ? 'text-green-600' : 'text-red-600'
                                        }`}>
