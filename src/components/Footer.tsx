            ...
            <div className="container mx-auto px-4 py-12 max-w-6xl">
                ...
                <div className="text-center mb-16">
                    ...
                    <div className="inline-block mb-6 relative">
                        <div className="absolute inset-0 bg-gradient-to-br from-[#00246A]/5 to-[#E30F28]/5 dark:from-blue-500/10 dark:to-red-500/10 rounded-full blur-2xl scale-150"></div>
                        <div ref={containerRef} className="relative bg-white dark:bg-slate-900 p-4 rounded-full shadow-xl border-4 border-gray-100 dark:border-slate-800 w-[150px] h-[150px] flex items-center justify-center overflow-hidden">
                            {animationData ? (
