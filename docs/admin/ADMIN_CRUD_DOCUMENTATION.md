...
- [x] Create new users (Students, Teachers, Administrators)
...
- [x] Filter by modality and status

- [x] Course duration management
...
- [x] View all exams with question counts
