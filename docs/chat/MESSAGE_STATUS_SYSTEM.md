...
- **- [x] Entregado**: Icono de check simple (`Check`) - El mensaje llegó al servidor

- **- [x]- [x] Leído**: Icono de doble check azul (`CheckCheck`) - Al menos un usuario leyó el mensaje
...
4. Mensaje aparece con ícono - [x] (entregado)
   ↓
...
8. Mensaje aparece con ícono - [x]- [x] (leído)
```
...
7. Ver mensaje marcado como "leído" (- [x]- [x])
...
- [x] Migración: Schema actualizado correctamente

- [x] Backend: APIs de entregado/leído/estado

- [x] Frontend: Iconos de estado en mensajes

- [x] Frontend: Indicador de conexión en header

- [x] Auto-marcado: Mensajes como leídos automáticamente

- [x] Auto-estado: Conexión basada en apertura de chat
