    ...
    return (
        ...
        >
            <div className="flex items-center mb-6">
                <CreditCard className="w-8 h-8 text-[#e30f28] dark:text-red-500 mr-3" />
                <h2 className="text-2xl font-bold text-slate-800 dark:text-slate-100">Mi Historial de Pagos</h2>
            </div>

            {payments.length === 0 ? (
                <div className="text-center py-12">
                    <DollarSign className="w-16 h-16 text-gray-400 dark:text-slate-500 mx-auto mb-4" />
                    <p className="text-gray-500 dark:text-slate-400 text-lg">No tienes pagos registrados</p>
                </div>
            ) : (
