                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                            <div className="flex-1">
                                <div className="flex items-center space-x-3 mb-2">
                                    ...
                                    <span
                                        className={`text-xs font-medium px-2 py-1 rounded-full ${classItem.status === "upcoming" ? "bg-blue-100 text-blue-600 dark:bg-blue-900/30 dark:text-blue-300" : "bg-green-100 text-green-600 dark:bg-green-900/30 dark:text-green-300"
                                            }`}
                                    >
                            ...
                            <div className="flex space-x-3">
                                {classItem.status === "upcoming" ? (
                                    ...
                                    <button className="bg-slate-100 hover:bg-slate-200 dark:bg-slate-700 dark:hover:bg-slate-600 text-[#00246a] dark:text-blue-300 px-6 py-2 rounded-xl font-medium transition-colors duration-200">
                                        Ver Grabación
                                    </button>
                                )}
                            </div>
