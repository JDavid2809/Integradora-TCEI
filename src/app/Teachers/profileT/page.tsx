...
export default function TeacherProfile() {
  ...
  const [profileData, setProfileData] = useState({
    name: "",
    title: "Profesor de Inglés Certificado",
    description:
      "Profesor de inglés con más de 5 años de experiencia. Especializado en conversación y preparación para certificaciones oficiales.",
    location: "Madrid, España",
    languages: "Inglés (Nativo), Español",
    experience: "5+ años",
    students: "500+ graduados",
    rating: "4.9",
    reviews: "127 valoraciones",
  })
  ...
  useEffect(() => {
    ...
    if (!session?.user || session.user.rol !== 'PROFESOR') {
      ...
      setProfileData(prev => ({
        ...prev,
        name: `${session.user.name} ${session.user.apellido}` || "Profesor"
      }))
    }
      ...
      <div className="max-w-6xl mx-auto px-6 py-6">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap justify-center lg:justify-start gap-4 text-blue-100">
                      ...
                      <div className="flex items-center gap-2 bg-white/20 rounded-full px-4 py-2">
                        ...
                        <span>{profileData.students}</span>
                      </div>
                      <div className="flex items-center gap-2 bg-white/20 rounded-full px-4 py-2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {/* Contact Section */}
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
              <h3 className="text-xl font-bold text-gray-900 mb-6">¿Listo para empezar?</h3>
              ...
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-xl p-4">
                <div className="flex items-center gap-3 text-blue-800">
                  ...
                  <p className="font-medium">Primera clase gratuita de 30 minutos disponible</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
              <h3 className="font-bold text-gray-900 mb-6 text-lg">Estadísticas</h3>
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 bg-yellow-50 rounded-xl border border-yellow-200">
                  <div className="flex items-center gap-3">
                    <Star className="h-5 w-5 text-yellow-500" />
                    <span className="text-gray-700 font-medium">Valoración</span>
                  </div>
                  <span className="font-bold text-gray-900 text-lg">{profileData.rating}/5</span>
                </div>
                <div className="flex items-center justify-between p-4 bg-blue-50 rounded-xl border border-blue-200">
                  <div className="flex items-center gap-3">
                    <Users className="h-5 w-5 text-blue-600" />
                    <span className="text-gray-700 font-medium">Estudiantes</span>
                  </div>
                ...
                <div className="flex items-center justify-between p-4 bg-purple-50 rounded-xl border border-purple-200">
                  ...
                  <span className="font-bold text-gray-900 text-lg">5+ años</span>
                </div>
              </div>
            </div>
