...
import { getDashboardMetrics, DashboardMetrics } from '@/actions/admin/dashboardMetrics'
import DashboardMetricsComponent from '@/components/admin/DashboardMetrics'
...
export default function AdminPage() {
  ...
  const navigationItems = [
    ...
    { id: 'metrics', name: 'Métricas', icon: TrendingUp, label: 'Métricas' },
  ...
  const renderMetricsSection = () => {
    ...
    return <DashboardMetricsComponent metrics={dashboardMetrics} />
  }
