...
export default function AdminProfile() {
  ...
  const [profileData, setProfileData] = useState({
    ...
    description:
      "Administrador responsable de la gestión y supervisión de la plataforma educativa. Encargado de mantener el sistema funcionando de manera óptima para todos los usuarios.",
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap justify-center lg:justify-start gap-4 text-blue-100">
                      ...
                      <div className="flex items-center gap-2 bg-white/20 rounded-full px-4 py-2">
                        ...
                        <span>{profileData.access}</span>
                      </div>
                      <div className="flex items-center gap-2 bg-white/20 rounded-full px-4 py-2">
                        <BarChart3 className="h-4 w-4" />
                        <span>{profileData.uptime}</span>
                      </div>
                    </div>
                  </div>
                )}
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between p-4 bg-blue-50 rounded-xl border border-blue-200">
                  ...
                  <span className="font-bold text-gray-900 text-lg">1,250</span>
                </div>
