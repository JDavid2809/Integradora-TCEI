        ...
        >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <motion.div variants={itemVariants} className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
                    <h3 className="text-lg font-semibold text-blue-600 mb-4">Actividad Reciente</h3>
                        ...
                        {[
                            ...
                            >
                                ...
                                <div className="flex-1">
                                    <p className="text-sm font-medium text-blue-600">{activity.action}</p>
                ...
                {/* Quick Actions */}
                <motion.div variants={itemVariants} className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
                    <h3 className="text-lg font-semibold text-blue-600 mb-4">Acciones Rápidas</h3>
                    <div className="space-y-3">
                        {[
                            ...
                            <button
                                key={index}
                                className="w-full flex items-center space-x-4 p-4 hover:bg-blue-50 rounded-xl transition-all duration-200 text-left group"
                            >
                                <div className={`w-10 h-10 ${action.color} rounded-lg flex items-center justify-center`}>
                                    <action.icon className="w-5 h-5 text-white" />
                                </div>
                                <div className="flex-1">
                                    <p className="font-medium text-blue-600">{action.title}</p>
                                    <p className="text-sm text-slate-600">{action.subtitle}</p>
                                </div>
                                <ChevronRight className="w-5 h-5 text-slate-400 group-hover:text-blue-500 transition-colors duration-200" />
                            </button>
                        ))}
                    </div>
                </motion.div>
